...
/* ------------------------------------------------------------------------- */
/* ========================================================================= */
#ifndef AITOWN_db_tokyo_h_INCLUDE
#define AITOWN_db_tokyo_h_INCLUDE
//
//
//
//
...
///
AITOWN_EXPORT void
aitown_db_tokyo_init (
        struct _aitown_db_mng_t *db_mng);


//! terminate a db_tokyo structure
///
/// @warning This method is intended for driver writers and should not be
/// called by the database users.
///
...
#endif
#endif /* AITOWN_db_tokyo_h_INCLUDE */
